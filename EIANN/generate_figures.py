...
def load_model(model_dict, overwrite):
...
def generate_Fig1(all_dataloaders, show=True, save=False):
    ...
    for model_name in model_dict:
        ...
        network = load_model(model_dict[model_name], overwrite)
        ...
        # Plot 2: Average population activity of H1E
        ...
        # Plot 3: Example output receptive fields
        ...
        pos = ax.get_position()
        new_left = pos.x0 - 0.05  # Move left boundary to the left
        new_bottom = pos.y0 + 0.15  # Move bottom boundary up
        new_width = pos.width + 0.04  # Increase width
        new_height = pos.height - 0.25  # Decrease height
