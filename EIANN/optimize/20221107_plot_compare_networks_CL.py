...
example_index_dict = {'van_BP': 0, 'BP_1_inh': 0, 'BTSP_C': 3}

activity_dict, metrics_dict = unpack_data_CL(model_list, data_file_path_dict)

plot_activity_CL(activity_dict, title_dict, example_index_dict, model_list[:1], False)
plot_activity_CL(activity_dict, title_dict, example_index_dict, model_list[1:])
plot_input_patterns_CL(activity_dict)
