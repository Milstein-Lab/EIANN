...
def update_EIANN_config_1_hidden_mnist_Gjorgjieva_Hebb_1_inh_D(x, context):
    ...
    H1_E_H1_FFI_weight_scale = param_dict['H1_E_H1_FFI_weight_scale']
    H1_FFI_Input_E_weight_scale = param_dict['H1_FFI_Input_E_weight_scale']

    Output_E_H1_E_weight_scale = param_dict['Output_E_H1_E_weight_scale'] * \
                                 math.sqrt(context.layer_config['H1']['E']['size']) / 2
    Output_E_H1_E_learning_rate = param_dict['Output_E_H1_E_learning_rate']

    Output_E_Output_FFI_weight_scale = param_dict['Output_E_Output_FFI_weight_scale']
    Output_FFI_H1_E_weight_scale = param_dict['Output_FFI_H1_E_weight_scale']

    context.projection_config['H1']['E']['Input']['E']['weight_constraint_kwargs']['scale'] = H1_E_Input_E_weight_scale
    context.projection_config['H1']['E']['Input']['E']['learning_rule_kwargs']['learning_rate'] = \
        H1_E_Input_E_learning_rate

    context.projection_config['H1']['E']['H1']['FFI']['weight_init_args'] = (-H1_E_H1_FFI_weight_scale,)
    context.projection_config['H1']['FFI']['Input']['E']['weight_init_args'] = (H1_FFI_Input_E_weight_scale,)
    ...
    context.projection_config['Output']['E']['Output']['FFI']['weight_init_args'] = (-Output_E_Output_FFI_weight_scale,)
    context.projection_config['Output']['FFI']['H1']['E']['weight_init_args'] = (Output_FFI_H1_E_weight_scale,)
